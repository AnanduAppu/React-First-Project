...
function Login() {
  ...
  return (
    <div className='logdiv'>
      ...
      <button className='inputBtn' type="submit">Next</button>
        <Link className='create text-dark' to="/registration"><strong>Create a New Account?</strong></Link>
       
      </form>

      <a className='bg-secondary'  onClick={()=>Navigate("/adminLog")}><AccountBoxIcon/></a>
    </div>
  );
}
